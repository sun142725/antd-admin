      ...
      >
        <div className={styles.modal_statistic}>
          ...
          >
            ...
            >
              <Select placeholder="请选择账单类型" className={styles.select_status}>
            ...
            >
              <Select placeholder="请选择账单种类" className={styles.select_status}>
            ...
            <FormItem {...formItemLayout} label="备注" name="mark">
              <TextArea style={{ minHeight: 32 }} placeholder="请输入注释信息" rows={4} />
            </FormItem>
