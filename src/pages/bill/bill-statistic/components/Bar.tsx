import { Axis, Chart, Geom, Tooltip, Legend, Label } from 'bizcharts';
import React, { Component } from 'react';

import Debounce from 'lodash.debounce';
import autoHeight from '../../../dashboard/analysis/components/Charts/autoHeight';
      ...
      <div style={{ height }} ref={this.handleRoot}>
        <div ref={this.handleRef}>
          ...
          >
            ...
            />
            <Axis name="amount" min={0} />
            <Tooltip />
            <Geom type="intervalStack" position="date*amount"  color={"category"}>
              <Label />
            </Geom>
          </Chart>
        </div>
